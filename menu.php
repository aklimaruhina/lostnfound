...
<?php if (isset($blocked)) { ?>
                <ul class="nav navbar-nav">
                    <li >
                        <a class="disabled-link">Dashboard</a>
                    </li>
                    <li>
                        <a class="disabled-link">Edit Profile</a>
                    </li>
                    <li>
                        <a class="disabled-link">Register New product</a>
                    </li>
                    <li>
                        <a class="disabled-link">Existing Product List</a>
                    </li>
...
<?php } else { ?>
                <ul class="nav navbar-nav ">
                    ...
                    <li <?php if (isset($profile)) { ?> class="active" <?php } ?>>
                    ...
                    <li <?php if (isset($product)) { ?> class="active" <?php } ?>>
